                ...
                <table class="table text-start align-middle table-bordered table-hover mb-0" style="font-size: 0.8em;">
                    ...
                    <tbody style="font-size: 1em;">
                        ...
                        <tr>
                            ...
                            <td>{{ $mapsBackpage->id_bengkel }}</td>
                            <td>{{ $mapsBackpage->koordinatX }}</td>
                            <td>{{ $mapsBackpage->koordinatY }}</td>
                            <td>
                                <a href="{{ route('maps_backpage.edit', $mapsBackpage->id_bengkel) }}" class="btn btn-warning">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <form action="{{ route('maps_backpage.destroy', $mapsBackpage->id_bengkel) }}" method="POST" class="d-inline">
                                    @csrf
                                    @method('DELETE')
